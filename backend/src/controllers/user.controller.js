        ...
        await sendMail({
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    <img src="https://example.com/path/to/your/logo.png" alt="Aroma Logo" style="display: block; margin: 0 auto; max-width: 200px; height: auto; margin-bottom: 20px;">
                    <h1 style="color: #333333; font-size: 24px; margin-bottom: 20px;">Hey ${firstName}, Welcome to Aroma Cafe.LK</h1>
                    ...
                    <p style="color: #666666; font-size: 16px; margin-bottom: 15px;">Aroma Team</p>
                </div>
            `
        }); 
