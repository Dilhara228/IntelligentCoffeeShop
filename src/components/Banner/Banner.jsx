          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Experience the perfect brew with our expertly roasted, high-quality coffee. From bold espressos to smooth cappuccinos, every cup is crafted for rich flavor and aroma. 
